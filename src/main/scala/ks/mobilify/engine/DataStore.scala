...
object DataStore {
  private val income1 = Income(1, "c1", "desc1", new SimpleDateFormat("yyyy-MM-dd").parse("2018-02-10"))("Test acccount 2")
  private val income2 = Income(1, "c1", "desc1", new SimpleDateFormat("yyyy-MM-dd").parse("2018-02-15"))("Test acccount 2")
  private val expense1 = Expense(4, "c2", "desc1", new SimpleDateFormat("yyyy-MM-dd").parse("2018-04-15"))("Test acccount 2")
  private val income3 = Income(10, "c1", "desc1", new Date)("Test acccount 2")
